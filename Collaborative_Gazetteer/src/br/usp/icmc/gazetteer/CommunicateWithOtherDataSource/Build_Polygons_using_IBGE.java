...
public class Build_Polygons_using_IBGE {
	...
	public static List<Place> loadNationalParks()throws Exception{
		...
		String path1 ="files"+File.separator+"trustCoordinates"+File.separator+"ucsfi.zip";
		String path2 ="files"+File.separator+"trustCoordinates"+File.separator+"EstadoAmazonas.zip";
	...
	public static List<County> loadMunicipality()throws Exception{
		...
		String path1 ="files"+File.separator+"trustCoordinates"+File.separator+"municip07.zip";
		String path2 ="files"+File.separator+"trustCoordinates"+File.separator+"EstadoAmazonas.zip";
	...
	public static List<Place> loadReservas() throws Exception{
		List<Place> places = new ArrayList<Place>();
		String path1 ="files"+File.separator+"trustCoordinates"+File.separator+"ucstodas.zip";
		String path2 ="files"+File.separator+"trustCoordinates"+File.separator+"EstadoAmazonas.zip";
